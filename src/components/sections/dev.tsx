...
import DevScene from '../three/scenes/dev-scene'

const Dev:React.FC = () => {
  return (
    <section className="bg-gradient-to-r w-full from-slate-900 to-cyan-400 min-h-screen text-white flex flex-wrap-reverse justify-between items-center">
      {/* R3F Canvas */}
      ...
      className="flex flex-col bg-200 gap-5 lg:w-1/2 lg:h-2/3 w-full p-14 rounded-tl-3xl rounded-bl-3xl bg-rose-200/10 backdrop-blur-md justify-center items-start">
        <h1 className="text-5xl font-extrabold">Contributing</h1>
        <p>
